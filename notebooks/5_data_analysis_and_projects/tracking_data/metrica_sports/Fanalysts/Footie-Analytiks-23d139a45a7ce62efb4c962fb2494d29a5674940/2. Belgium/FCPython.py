"""
Created on Sun Apr  5 19:42:41 2020
...
def createPitch(length,width, unity,linecolor): # in meters
    ...
    #check unity again
        ...
        #Run program if unity and boundaries are accepted
            ...
            #Right Goal
            plt.plot([length,length+2.67],[width/2-4,width/2-4],color=linecolor)
            plt.plot([length,length+2.67],[width/2+4,width/2+4],color=linecolor)
            plt.plot([length+2.67,length+2.67],[width/2+4,width/2-4],color=linecolor)
            
            
            #Left Goal
            plt.plot([0,0-2.67],[width/2-4,width/2-4],color=linecolor)
            plt.plot([0,0-2.67],[width/2+4,width/2+4],color=linecolor)  
            plt.plot([-2.67,-2.67],[width/2+4,width/2-4],color=linecolor)
            ...
            #Prepare Arcs
            leftArc = Arc((11,width/2),height=20,width=20,angle=0,theta1=315,theta2=45,color=linecolor)
