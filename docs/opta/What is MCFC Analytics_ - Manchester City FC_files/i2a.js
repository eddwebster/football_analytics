...
function pixel() {
    var icstring = ".ic-live.com/goat.php?cID=1554&cdid=5042&campID=8";
    ...
    if (!ic_cat) { ic_cat = ""; }
    if (!ic_type) { ic_type = ""; }
    if (locHttp.toLowerCase() == "https") { prefix = "https://web.archive.org/web/20120817225630/https://www" + icstring + ""; }
    if (locHttp.toLowerCase() == "http") { prefix = "https://web.archive.org/web/20120817225630/http://1554" + icstring + ""; }
...
/*
     FILE ARCHIVED ON 22:56:30 Aug 17, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:30:02 Dec 07, 2020.
...
/*
playback timings (ms):
  captures_list: 101.721
  exclusion.robots.policy: 0.191
  esindex: 0.015
  RedisCDXSource: 9.503
  PetaboxLoader3.datanode: 75.19 (4)
  PetaboxLoader3.resolve: 36.541
  CDXLines.iter: 25.755 (3)
  exclusion.robots: 0.208
  load_resource: 66.152
  LoadShardBlock: 59.493 (3)
*/