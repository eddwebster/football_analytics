...
MCFC.share = function ($) {
	...
	var services = {
		facebook : function (url, title) {
			return popup('https://web.archive.org/web/20120823182916/http://www.facebook.com/sharer.php?u='+url+'&t='+title);
		},
		digg : function (url, title) {
			return popup('https://web.archive.org/web/20120823182916/http://digg.com/submit?url='+url+'&amp;title='+title+'&amp;media=news&amp;topic=soccer');
		},		
		delicious : function (url, title) {
			return popup('https://web.archive.org/web/20120823182916/http://delicious.com/save?v=5&amp;noui&amp;jump=close&amp;url='+url+'&amp;title='+title);
		},
		twitter : function (url, title) {
		    var msg = title + '%20@%20' + url;
		    return popup('https://web.archive.org/web/20120823182916/http://twitter.com/home?status='+msg);
		},
...
/*
     FILE ARCHIVED ON 18:29:16 Aug 23, 2012 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  PetaboxLoader3.datanode: 195.454 (4)
  exclusion.robots.policy: 0.165
  RedisCDXSource: 0.729
  PetaboxLoader3.resolve: 26.284
  exclusion.robots: 0.178
  captures_list: 222.725
  load_resource: 45.424
  LoadShardBlock: 188.347 (3)
